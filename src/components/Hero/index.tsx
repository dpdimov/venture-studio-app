          ...
          <div className="w-full px-4">
            <div className="mx-auto max-w-[800px] text-center">
              ...
              <p className="mb-12 text-base !leading-relaxed text-body-color sm:text-lg md:text-xl">
                Present your venture to a community of students, alumni, and
                professionals — and get the feedback that matters.
              </p>
              <div className="mx-auto grid max-w-[640px] gap-5 sm:grid-cols-2">
                ...
                >
                  ...
                  <p className="text-sm leading-relaxed text-body-color">
                    Present your idea with a structured pitch and reach stakeholders eager to support the next generation of founders.
                  </p>
                </Link>
                <Link
                  href="/ventures"
                ...
                >
                  ...
                  <p className="text-sm leading-relaxed text-body-color">
                    Discover projects, evaluate their potential, and provide feedback that helps ventures grow.
                  </p>
                </Link>
              </div>
            </div>
        ...
        <svg width="450" height="556" viewBox="0 0 450 556" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            <linearGradient id="paint0_linear_25:217" x1="-54.5003" y1="-178" x2="222" y2="288" gradientUnits="userSpaceOnUse">
              <stop stopColor="#1270B4" /><stop offset="1" stopColor="#1270B4" stopOpacity="0" />
            </linearGradient>
            <radialGradient id="paint1_radial_25:217" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(17.9997 182) rotate(90) scale(18)">
              <stop offset="0.145833" stopColor="#1270B4" stopOpacity="0" /><stop offset="1" stopColor="#1270B4" stopOpacity="0.08" />
            </radialGradient>
            ...
            <linearGradient id="paint4_linear_25:217" x1="184.521" y1="182.159" x2="184.521" y2="448.882" gradientUnits="userSpaceOnUse">
              <stop stopColor="#1270B4" /><stop offset="1" stopColor="white" stopOpacity="0" />
            </linearGradient>
        ...
        <svg width="364" height="201" viewBox="0 0 364 201" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            <linearGradient id="paint0_linear_25:218" x1="184.389" y1="69.2405" x2="184.389" y2="212.24" gradientUnits="userSpaceOnUse">
              <stop stopColor="#1270B4" stopOpacity="0" /><stop offset="1" stopColor="#1270B4" />
            </linearGradient>
