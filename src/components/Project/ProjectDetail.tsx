            ...
            project && (
              <div className="w-full px-4 lg:w-8/12">
                <div className="rounded-card border border-gray-200 bg-white p-8 shadow-card sm:p-12">
                  <h2 className="mb-8 font-serif text-3xl font-bold leading-tight text-black sm:text-4xl sm:leading-tight">
                    {project.title}
                  </h2>
                  <div className="mb-10 flex flex-wrap items-center justify-between border-b border-gray-200 pb-4">
                    <div className="flex flex-wrap items-center">
                      <div className="mb-5 mr-10 flex items-center">
                        <div className="w-full">
                          <span className="mb-1 text-base font-medium text-body-color">
                            By <span className="text-black">{project.createdBy?.name}</span>
                          </span>
                        </div>
                      </div>
                  ...
                  <div>
                    ...
                    {pitchSections.map(({ title, content }) => (
                      <div key={title}>
                        <h3 className="mb-2 mt-6 font-serif text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">
                          {title}
                        </h3>
                      ...
                      <>
                        ...
                        {project.attachments.map((attachment, idx) => (
                          <a key={idx} href={attachment.src} target="_blank" rel="noopener noreferrer">
                            <p className="text-base italic text-primary underline">
                    ...
                    {project.surveyEnabled && (
                      <div className="mt-8 py-4">
                        <Link
                          ...
                          className="rounded-lg bg-primary px-8 py-4 text-base font-semibold text-white shadow-btn transition duration-300 hover:bg-primary/90"
                        >
                          Evaluate
                        </Link>
                      </div>
